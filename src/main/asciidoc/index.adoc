...
#### 유저 카드 등록상태 확인
.request
include::{snippets}/user/유저_카드등록상태_확인/http-request.adoc[]

.response
include::{snippets}/user/유저_카드등록상태_확인/http-response.adoc[]
include::{snippets}/user/유저_카드등록상태_확인/response-fields.adoc[]