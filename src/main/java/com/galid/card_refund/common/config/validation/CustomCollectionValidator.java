...
public class CustomCollectionValidator implements Validator {
    ...
    public CustomCollectionValidator(SpringValidatorAdapter adapter) {
        this.adapter = new SpringValidatorAdapter(Validation.buildDefaultValidatorFactory().getValidator());
    }
